...
public class TtlMDCAdapter implements MDCAdapter {
	...
	final TransmittableThreadLocal<Map<String, String>> readWriteThreadLocalMap = new TransmittableThreadLocal<Map<String, String>>();
	...
	final TransmittableThreadLocal<Map<String, String>> readOnlyThreadLocalMap = new TransmittableThreadLocal<Map<String, String>>();
	 ...
	 * <p/>
	 * <p/>
	 * Each time a value is added, a new instance of the map is created. This is to be
	 * certain that the serialization process will operate on the updated map and not send
	 * a reference to the old map, thus not allowing the remote logback component to see
	 * the latest changes.
