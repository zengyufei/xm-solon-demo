...
public class QueryMethod {
	...
	public QueryMethod(Method javaMethod, Query query, int pageableParamIndex, int sortParamIndex,
	...
	public String toString() {
		return "QueryMethod{" + "javaMethod=" + javaMethod + ", query=" + query + ", pageableParamIndex="
				+ pageableParamIndex + ", sortParamIndex=" + sortParamIndex + ", fetcherParamIndex=" + fetcherParamIndex
				+ '}';
	}
