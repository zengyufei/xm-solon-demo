;(function umd(root, factory) {
    if (typeof module === "object" && typeof exports === "object") module.exports = factory()
    ...
    TemplateContext.prototype = {
        ...
        getRootElt: function () {
            ...
            for (tplElt = tplElt.firstChild; tplElt !== null; tplElt = tplElt.nextSibling) if (tplElt.nodeType === Node.ELEMENT_NODE) return tplElt
    ...
    Component.prototype = {
        ...
        normalize: function () {
            return Promise.all(Array.prototype.concat(this._normalizeSection(this.template), this._normalizeSection(this.script), this.styles.map(this._normalizeSection))).then(
                function () {
                    return this
                }.bind(this)
            )
            ...
            beforeCreate: function () {
                ...
                for (var componentName in components) {
                    if (typeof components[componentName] === "string" && components[componentName].substr(0, 4) === "url:") {
                        ...
                        if (isNaN(componentName)) components[componentName] = httpVueLoader.load(componentURL, componentName)
                        else components[componentName] = Vue.component(comp.name, httpVueLoader.load(componentURL, comp.name))
                    }
                }
            },
        })
