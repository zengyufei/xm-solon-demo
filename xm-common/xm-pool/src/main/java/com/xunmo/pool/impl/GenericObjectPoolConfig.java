...
/**
 * A simple structure encapsulating the configuration for a {@link GenericObjectPool}.
 *
 * <p>
...
public class GenericObjectPoolConfig<T> extends BaseObjectPoolConfig<T> {
	...
	/**
	 * Get the value for the {@code maxIdle} configuration attribute for pools created
	...
	/**
	 * Set the value for the {@code maxIdle} configuration attribute for pools created
	 * with this configuration instance.
	...
	/**
	 * Get the value for the {@code minIdle} configuration attribute for pools created
	 * with this configuration instance.
	...
	/**
	 * Set the value for the {@code minIdle} configuration attribute for pools created
	 * with this configuration instance.
