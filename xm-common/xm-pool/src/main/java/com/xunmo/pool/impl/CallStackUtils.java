...
public final class CallStackUtils {
	 ...
	 * @return {@code true} if it is able to create a security manager in the current
	 ...
	 * @param useTimestamp if true, interpret message as a SimpleDateFormat and print the
	 * created timestamp; otherwise, print message format literally
	 ...
	 * @param useTimestamp if true, interpret message as a SimpleDateFormat and print the
	 * created timestamp; otherwise, print message format literally
	 * @param requireFullStackTrace if true, forces the use of a stack walking mechanism
	 * that includes full stack trace information; otherwise, uses a faster implementation
	 * if possible
	 * @return a new CallStack
	 * @since 2.5
	 */
