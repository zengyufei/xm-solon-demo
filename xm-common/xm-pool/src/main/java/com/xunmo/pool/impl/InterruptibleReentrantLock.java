 ...
 * interrupted when the pool using the queue that uses this lock is closed. The class is
...
class InterruptibleReentrantLock extends ReentrantLock {
	 ...
	 * @param fairness true means threads should acquire contended locks as if waiting in
	 * a FIFO queue
	 */
