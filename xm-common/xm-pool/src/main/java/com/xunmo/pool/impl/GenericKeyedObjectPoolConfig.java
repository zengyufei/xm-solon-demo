 ...
 *
 * <p>
 * This class is not thread-safe; it is only intended to be used to provide attributes
...
public class GenericKeyedObjectPoolConfig<T> extends BaseObjectPoolConfig<T> {
	...
	/**
	 * Get the value for the {@code maxIdlePerKey} configuration attribute for pools
	 * created with this configuration instance.
	 * @return The current setting of {@code maxIdlePerKey} for this configuration
	 * instance
	 * @see GenericKeyedObjectPool#getMaxIdlePerKey()
	 */
	...
	/**
	 * Set the value for the {@code maxIdlePerKey} configuration attribute for pools
	 * created with this configuration instance.
	 * @param maxIdlePerKey The new setting of {@code maxIdlePerKey} for this
	...
	/**
	 * Get the value for the {@code maxTotal} configuration attribute for pools created
	...
	/**
	 * Set the value for the {@code maxTotal} configuration attribute for pools created
	 * with this configuration instance.
	...
	/**
	 * Get the value for the {@code maxTotalPerKey} configuration attribute for pools
	 * created with this configuration instance.
	 * @return The current setting of {@code maxTotalPerKey} for this configuration
	 * instance
	 * @see GenericKeyedObjectPool#getMaxTotalPerKey()
	 */
	...
	/**
	 * Set the value for the {@code maxTotalPerKey} configuration attribute for pools
	 * created with this configuration instance.
	 * @param maxTotalPerKey The new setting of {@code maxTotalPerKey} for this
	 * configuration instance
	...
	/**
	 * Get the value for the {@code minIdlePerKey} configuration attribute for pools
	 * created with this configuration instance.
	 * @return The current setting of {@code minIdlePerKey} for this configuration
	 * instance
	 * @see GenericKeyedObjectPool#getMinIdlePerKey()
	 */
	...
	/**
	 * Set the value for the {@code minIdlePerKey} configuration attribute for pools
	 * created with this configuration instance.
	 * @param minIdlePerKey The new setting of {@code minIdlePerKey} for this
	 * configuration instance
